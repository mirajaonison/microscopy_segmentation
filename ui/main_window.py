...
class MainWindow(wx.Frame):
    ...
    def __init__(self, *args, **kw):
        ...
        reset_btn = button.Button(panel, "Reset", wx.Point(
            20, 310), wx.Size(80, 30), "reset")
    ...
    def process(self, event):
        ...
        try:
            ...
            self.results.setValue(f"{exception}")
            return
        # Count white 
        number_white = np.sum(img_thr.flatten())
    ...
    def reset(self, event):
        self.source_image = self.default_image
        self.preview_image(wx.Image(self.transform_ndarray_to_bufferImage(self.source_image)))
